...
function richBody(topic: string) {
  return [
    ...
    callout(
      "info",
      `This section covers the fundamentals of ${topic.toLowerCase()}.`,
    ),
    h3("Key Concepts"),
    ...
    callout(
      "tip",
      "Pro tip: Always test your configuration in a safe environment before applying changes.",
    ),
    ...
    callout(
      "warning",
      "Caution: This method involves higher risk. Ensure adequate resources before proceeding.",
    ),
    p(L.para3),
    quote(
      "In the howling depths of space, preparation separates the profitable from the bankrupt.",
    ),
    h2("Summary"),
    p(L.med),
    p(L.para4),
    callout(
      "danger",
      "Remember: PVP-lootable zones carry real risk. Never carry more than you can afford to lose.",
    ),
  ];
}
...
async function main() {
  ...
  const images = {
    hero1: await uploadImage(
      "https://picsum.photos/seed/hm-hero1/1600/900",
      "hero-1.jpg",
    ),
    hero2: await uploadImage(
      "https://picsum.photos/seed/hm-hero2/1600/900",
      "hero-2.jpg",
    ),
    cover1: await uploadImage(
      "https://picsum.photos/seed/hm-cover1/800/450",
      "cover-1.jpg",
    ),
    cover2: await uploadImage(
      "https://picsum.photos/seed/hm-cover2/800/450",
      "cover-2.jpg",
    ),
    cover3: await uploadImage(
      "https://picsum.photos/seed/hm-cover3/800/450",
      "cover-3.jpg",
    ),
    cover4: await uploadImage(
      "https://picsum.photos/seed/hm-cover4/800/450",
      "cover-4.jpg",
    ),
    cover5: await uploadImage(
      "https://picsum.photos/seed/hm-cover5/800/450",
      "cover-5.jpg",
    ),
    cover6: await uploadImage(
      "https://picsum.photos/seed/hm-cover6/800/450",
      "cover-6.jpg",
    ),
    feature1: await uploadImage(
      "https://picsum.photos/seed/hm-feat1/600/400",
      "feature-1.jpg",
    ),
    feature2: await uploadImage(
      "https://picsum.photos/seed/hm-feat2/600/400",
      "feature-2.jpg",
    ),
    feature3: await uploadImage(
      "https://picsum.photos/seed/hm-feat3/600/400",
      "feature-3.jpg",
    ),
    feature4: await uploadImage(
      "https://picsum.photos/seed/hm-feat4/600/400",
      "feature-4.jpg",
    ),
    gallery1: await uploadImage(
      "https://picsum.photos/seed/hm-gal1/800/600",
      "gallery-1.jpg",
    ),
    gallery2: await uploadImage(
      "https://picsum.photos/seed/hm-gal2/800/600",
      "gallery-2.jpg",
    ),
    gallery3: await uploadImage(
      "https://picsum.photos/seed/hm-gal3/800/600",
      "gallery-3.jpg",
    ),
    gallery4: await uploadImage(
      "https://picsum.photos/seed/hm-gal4/800/600",
      "gallery-4.jpg",
    ),
    gallery5: await uploadImage(
      "https://picsum.photos/seed/hm-gal5/800/600",
      "gallery-5.jpg",
    ),
    gallery6: await uploadImage(
      "https://picsum.photos/seed/hm-gal6/800/600",
      "gallery-6.jpg",
    ),
  };
  console.log("");
  ...
  const categories = [
    ...
    },
    {
      ...
      description:
        "Market analysis, auction tips, and trade route optimization.",
    },
    {
      _id: "cat-exploration",
      _type: "category",
  ...
  const guides = [
    {
      ...
      excerpt:
        "Everything a new miner needs to know to drop their first probe and hit their first global in the Howling Mine sector.",
    ...
    },
    {
      ...
      excerpt:
        "A comprehensive breakdown of every finder in the game, their depth ranges, decay costs, and optimal use cases.",
    ...
    },
    {
      ...
      excerpt:
        "How to mine efficiently in PVP-lootable asteroid zones while minimizing losses to pirates and griefers.",
    ...
    },
    {
      ...
      excerpt:
        "Understanding mob HP, damage types, loot tables, and how to choose the right weapon and armor for each creature.",
    ...
    },
    {
      ...
      excerpt:
        "How to identify profitable items, read markup trends, time your auctions, and build a steady income stream from trading.",
    ...
    },
    {
      ...
      excerpt:
        "Master the art of space travel: setting waypoints, reading sector coordinates, and navigating to asteroids efficiently.",
  ...
  const posts = [
    {
      ...
      excerpt:
        "Three previously uncharted asteroid fields have been added to the Howling Mine sector map, including two M-type clusters.",
      coverImage: imageRef(images.cover1),
    ...
    },
    {
      ...
      excerpt:
        "This week saw unprecedented mining activity with over 150 globals recorded across the sector. Full breakdown inside.",
      coverImage: imageRef(images.cover2),
      author: { _type: "reference", _ref: "author-howling-mine" },
      categories: [{ _type: "reference", _ref: "cat-news", _key: key() }],
    ...
    },
    {
      ...
      excerpt:
        "Join the Howling Mine society for a coordinated mining event this weekend. Prizes for top miners and most creative claims.",
      coverImage: imageRef(images.cover3),
      author: { _type: "reference", _ref: "author-howling-mine" },
      categories: [
    ...
    },
    {
      ...
      excerpt:
        "A breakdown of the latest game patch affecting finder decay, new resource types, and adjusted loot tables.",
      coverImage: imageRef(images.cover4),
      author: { _type: "reference", _ref: "author-howling-mine" },
      categories: [{ _type: "reference", _ref: "cat-news", _key: key() }],
    ...
    },
    {
      ...
      excerpt:
        "A coordinated pirate attack on miners at M-Big Delta resulted in significant losses. Here's what happened and how to protect yourself.",
      coverImage: imageRef(images.cover5),
      author: { _type: "reference", _ref: "author-howling-mine" },
      categories: [
        { _type: "reference", _ref: "cat-news", _key: key() },
    ...
    },
    {
      ...
      excerpt:
        "The Howling Mine society welcomes twelve new members this month. Meet the newest miners joining our ranks.",
      coverImage: imageRef(images.cover6),
      author: { _type: "reference", _ref: "author-howling-mine" },
  ...
  const pages = [
    // ─── About Page ───
    {
      ...
      description:
        "Learn about The Howling Mine — a mining society in Entropia Universe dedicated to space mining.",
      sections: [
        {
          ...
          subheading:
            "A society of miners, explorers, and pioneers carving profit from the asteroids of Entropia Universe.",
          breadcrumb: "About",
          align: "center",
        },
        {
          ...
          body: [
            ...
            bullet(
              "Build a community of experienced and aspiring space miners",
            ),
            bullet(
              "Map and document every asteroid in the Howling Mine sector",
            ),
    ...
    // ─── Features Page ───
    {
      ...
      description:
        "Explore the tools and features built by The Howling Mine for Entropia Universe miners.",
      sections: [
        {
          _type: "pageHeroSection",
          _key: key(),
          ...
          subheading:
            "Everything we've built to help miners succeed in the Howling Mine sector.",
          breadcrumb: "Features",
          align: "center",
        },
        {
          ...
          features: [
            {
              ...
              description:
                "3D WebGL map of every asteroid, station, and POI with copyable in-game coordinates.",
              icon: "map",
              href: "/map",
            },
            {
              ...
              description:
                "Real-time global and HoF tracking with 24-hour rolling statistics per asteroid.",
              icon: "bar-chart-3",
            },
            {
              _key: key(),
              ...
              description:
                "Calculate expected returns based on finder tier, depth, and current markup rates.",
              icon: "calculator",
            },
            {
              _key: key(),
              title: "Mining Guides",
              description:
                "Comprehensive guides from beginner basics to advanced PVP mining strategies.",
              icon: "book-open",
              href: "/guides",
            },
            {
              ...
              title: "Claim Tracker",
              description:
                "Log your mining runs, track claims, and analyze your long-term profitability.",
              icon: "clipboard-list",
            },
            {
              _key: key(),
              ...
              description:
                "Join 200+ active miners sharing intel, coordinating runs, and helping new players.",
              icon: "message-circle",
            },
          ],
          columns: 3,
      ...
      sections: [
        {
          ...
          heading: "Gallery",
          subheading:
            "Scenes from the Howling Mine sector — asteroids, globals, and the void between.",
          breadcrumb: "Gallery",
          align: "center",
        },
        {
          ...
          images: [
            {
              ...
              alt: "Asteroid field at sunset",
              caption: "C-Type cluster viewed from approach vector",
            },
            {
              _key: key(),
              image: imageRef(images.gallery2),
              alt: "Mining claim explosion",
              caption: "Global hit on M-Big Delta",
            },
            {
              _key: key(),
              image: imageRef(images.gallery3),
              alt: "Space station exterior",
              caption: "Howling Mine station docking bay",
            },
            {
              _key: key(),
              image: imageRef(images.gallery4),
              alt: "Nebula background",
              caption: "Nebula visible from the outer ring",
            },
            {
              _key: key(),
              image: imageRef(images.gallery5),
              alt: "PVP zone warning",
              caption: "Entering the PVP-lootable zone",
            },
            {
              _key: key(),
              image: imageRef(images.gallery6),
              alt: "Mining operation",
              caption: "Coordinated mining run in progress",
            },
          ],
          layout: "grid",
          columns: 3,
    ...
    // ─── FAQ Page ───
    {
      ...
      description:
        "Frequently asked questions about The Howling Mine society and space mining.",
      sections: [
        {
          _type: "pageHeroSection",
          _key: key(),
          ...
          subheading:
            "Common questions about The Howling Mine, mining mechanics, and our community.",
          breadcrumb: "FAQ",
          align: "center",
        },
        {
          ...
          body: [
            ...
            p(
              "The Howling Mine is a mining-focused society in Entropia Universe. We provide tools, guides, and community for space miners of all experience levels.",
            ),
            h3("How do I join?"),
            p(
              "Join our Discord server and introduce yourself. An officer will review your application and get you set up within 24 hours.",
            ),
            h3("Is there a membership fee?"),
            p(
              "No. The Howling Mine is free to join. We believe in open access to mining knowledge and community support.",
            ),
            h3("What platform is this for?"),
            p(
              "Entropia Universe — specifically the space mining sector. Our tools and guides focus on asteroid mining, but we welcome all professions.",
            ),
          ],
          maxWidth: "narrow",
        },
        {
          ...
          body: [
            ...
            callout(
              "warning",
              "PVP zones offer higher yields but you can lose everything you're carrying. Start with safe zones until you're experienced.",
            ),
    ...
    // ─── Contact Page ───
    {
      ...
      sections: [
        ...
        },
        {
          ...
          body: [
            p(
              "The fastest way to reach us is through our Discord server. Our officers are active daily and typically respond within a few hours.",
            ),
            h3("Discord"),
            p(
              "Join the server and post in #general or #support for the quickest response.",
            ),
            h3("In-Game"),
            p(
              "Send a message to any Howling Mine officer in Entropia Universe. Look for the [HM] tag.",
            ),
            h3("Email"),
            p(
              "For business enquiries or partnership proposals, reach out via email. Response time is typically 48 hours.",
            ),
            callout(
              "info",
              "For urgent matters, Discord is always the fastest channel. Our team monitors it around the clock.",
            ),
          ],
          maxWidth: "narrow",
        },
  ...
  console.log(
    "   Categories: mining, hunting, trading, exploration, news, community",
  );
}
